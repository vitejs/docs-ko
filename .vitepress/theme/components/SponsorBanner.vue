...
<template>
  <div class="banner" v-if="open">
    <svg
      ...
      height="12"
      fill="none"
      viewBox="0 0 103 15" data-ko-29="표시"
    >
      <path
      ...
      />
      <path
        d="M91.184 14.654a.363.363 0 0 1-.648-.224v-3.303c0-.4-.324-.725-.725-.725h-3.647c-.295 0-.467-.334-.295-.573l2.398-3.357a.725.725 0 0 0-.59-1.147h-4.414c-.295 0-.467-.334-.295-.574L86.076.4a.36.36 0 0 1 .295-.152h9.263c.295 0 .467.334.295.573l-2.398 3.358a.725.725 0 0 0 .59 1.147h3.648c.302 0 .472.348.285.587z" data-ko-36="표시"
        fill="#6254fe"
      />
      <mask
        id="a"
      ...
      <g mask="url(#a)">
        <g filter="url(#b)">
          <ellipse
            ...
            rx="1.766"
            ry="4.714"
            transform="rotate(89.814 35.524 46.024)scale(1 -1)" data-ko-61="표시"
          />
        </g>
        <g filter="url(#c)">
          <ellipse
            ...
            rx="3.334"
            ry="9.57"
            transform="rotate(89.814 33.737 36.63)scale(1 -1)" data-ko-71="표시"
          />
        </g>
        <g filter="url(#d)">
          <ellipse
            ...
            rx="1.766"
            ry="9.774"
            transform="rotate(89.814 33.002 36.998)scale(1 -1)" data-ko-81="표시"
          />
        </g>
        <g filter="url(#e)">
          <ellipse
            ...
            rx="1.766"
            ry="9.81"
            transform="rotate(89.814 30.844 40.622)scale(1 -1)" data-ko-91="표시"
          />
        </g>
        <g filter="url(#f)">
          <ellipse
            ...
            rx="1.766"
            ry="9.81"
            transform="rotate(89.814 30.904 41.053)scale(1 -1)" data-ko-101="표시"
          />
        </g>
        <g filter="url(#g)">
          <ellipse
            ...
            rx="4.511"
            ry="7.078"
            transform="rotate(93.35 49.173 54.748)scale(-1 1)" data-ko-111="표시"
          />
        </g>
        <g filter="url(#h)">
          <ellipse
            ...
            rx="1.113"
            ry="6.893"
            transform="rotate(89.009 50.51 57.537)scale(-1 1)" data-ko-121="표시"
          />
        </g>
        <g filter="url(#i)">
          <ellipse
            ...
            rx="1.113"
            ry="6.893"
            transform="rotate(89.009 50.51 57.537)scale(-1 1)" data-ko-131="표시"
          />
        </g>
        <g filter="url(#j)">
          <ellipse
            ...
            rx="1.413"
            ry="9.332"
            transform="rotate(39.51 82.99 3.123)" data-ko-141="표시"
          />
        </g>
        <g filter="url(#k)">
          <ellipse
            ...
            rx="1.413"
            ry="9.332"
            transform="rotate(37.892 98.102 -1.706)" data-ko-151="표시"
          />
        </g>
        <g filter="url(#l)">
          <ellipse
            ...
            rx="2.655"
            ry="4.005"
            transform="rotate(37.892 95.97 3.395)" data-ko-161="표시"
          />
        </g>
        <g filter="url(#m)">
          <ellipse
            ...
            rx="1.413"
            ry="9.332"
            transform="rotate(37.892 82.264 12.536)" data-ko-171="표시"
          />
        </g>
        <g filter="url(#n)">
          <ellipse
            ...
            rx="1.413"
            ry="9.332"
            transform="rotate(37.892 82.264 12.536)" data-ko-181="표시"
          />
        </g>
        <g filter="url(#o)">
          <ellipse
            ...
            rx="1.501"
            ry="9.332"
            transform="rotate(37.892 94.226 9.78)" data-ko-191="표시"
          />
        </g>
        <g filter="url(#p)">
          <ellipse
            ...
            rx="2.578"
            ry="6.754"
            transform="rotate(37.892 95.66 10.827)" data-ko-201="표시"
          />
        </g>
      </g>
      <path
        d="M80.53 0c-2.949 4.221-2.966 10.764 0 15h1.993c-2.966-4.236-2.949-10.779 0-15zM100.543 0H98.55c2.949 4.221 2.966 10.764 0 15h1.993c2.965-4.236 2.948-10.779 0-15" data-ko-206="표시"
        fill="#ffffff"
      />
      <defs>
        <filter
    ...
    <button @click="dismiss">
      <svg
        ...
        aria-hidden="true"
        focusable="false"
        viewBox="0 0 24 24" data-ko-468="표시"
      >
        <path
