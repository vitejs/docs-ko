...
Vite는 특히 문서와 재현을 위한 플레이그라운드 사용 사례에서 설치 속도를 높이기 위해 공간을 중요하게 생각합니다. 그리고 다시 한 번, 이 메이저 버전은 Vite의 패키지 크기 개선을 가져왔습니다. Vite 4 설치 크기는 vite 3.2.5에 비해 23% 작습니다(14.1 MB vs 18.3 MB).
