...
![Vite 4.3 발표 커버 이미지](/og-image-announcing-vite4-3.webp)
...
![Vite 4.3과 4.2의 시작 시간 비교](../images/vite4-3-startup-time.webp)

![Vite 4.3과 4.2의 HMR 시간 비교](../images/vite4-3-hmr-time.webp)
...
- 운영체제: Windows 10 Pro 21H2 19044.2846
- 런타임: Node.js 18.16.0
- Vite 및 React 플러그인 버전
  - Vite 4.2 (babel): Vite 4.2.1 + plugin-react 3.1.0 조합
  - Vite 4.3 (babel): Vite 4.3.0 + plugin-react 4.0.0-beta.1 조합
  - Vite 4.2 (swc): Vite 4.2.1 + plugin-react-swc 3.2.0 조합
  - Vite 4.3 (swc): Vite 4.3.0 + plugin-react-swc 3.3.0 조합
