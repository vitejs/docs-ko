...
프리 릴리스는 생태계의 얼리 어답터와 유지 관리자가 통합 및 안정성 테스트를 수행하고 피드백을 제공할 수 있게 합니다. 프리 릴리스를 프로덕션에서 사용하지 마세요. 모든 프리 릴리스는 불안정한 것으로 간주되며, 그 사이에 호환성이 깨지는 변경 사항이 포함될 수 있습니다. 프리 릴리스를 사용할 때는 항상 정확한 버전으로 고정하세요.
